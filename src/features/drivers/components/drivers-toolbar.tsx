    ...
    <div className="flex shrink-0 flex-col gap-4 sm:flex-row sm:items-center">
      <div className="relative min-w-0 flex-1">
        ...
        <input
          ...
          placeholder="Search by driver name, ID, phone..."
          type="search"
          value={searchValue}
        />
      </div>
      <button
        ...
        type="button"
      ><svg aria-hidden="true" className="size-4" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 20 20"><path d="M10 4v12M4 10h12"/></svg>Add New Driver</button>
    </div>
  );
}
