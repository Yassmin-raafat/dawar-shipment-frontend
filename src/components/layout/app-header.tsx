  ...
  return (
    <header className="flex h-20 shrink-0 items-center justify-end gap-3 px-5 sm:px-7">
      ...
      <details className="relative">
        <summary aria-label={t("notifications")} className="grid size-9 cursor-pointer list-none place-items-center rounded-full border border-border/60 bg-card text-text-muted [&::-webkit-details-marker]:hidden">
        ...
        <div className="absolute end-0 top-12 z-20 w-56 rounded-xl border border-border bg-card p-4 text-xs text-text-secondary shadow-lg">{t("noNotifications")}</div>
      </details>
      <details className="relative">
        <summary className="flex cursor-pointer list-none items-center gap-2 rounded-full border border-border/60 bg-card py-1 ps-1 pe-3 text-xs text-text-primary [&::-webkit-details-marker]:hidden">
        ...
        <div className="absolute end-0 top-12 z-20 w-40 rounded-xl border border-border bg-card p-1 shadow-lg">
